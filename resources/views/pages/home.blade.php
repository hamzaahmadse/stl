        ...
        <section class="home-slider" id="up">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide flex-min-height-box home-slide">
                    <!-- slide-bg -->
                    <div class="slide-bg overlay-loading2 overlay-dark-bg-1" style="background-image:url({{asset('assets/images/backgrounds/slider_1.jpg')}})"></div>
                            ...
                            <div class="six-columns six-offset">
                                <div class="content-left-margin-40">
                                    ...
                                    <p class="p-style-bold-up text-height-20 d-flex-wrap">
                                        <span class="slider-title-fill slider-tr-delay04" data-text="SEE THE LIGHT">SEE THE LIGHT</span>
...
{{--                                        <span class="slider-title-fill slider-tr-delay06" data-text="live-edge vegan">live-edge vegan</span>--}}
                ...
                <div class="swiper-slide flex-min-height-box home-slide">
                    <!-- slide-bg -->
                    <div class="slide-bg" style="background-image:url({{asset('assets/images/backgrounds/slider_2.jpg')}})"></div>
                    <!-- home-slider-content start -->
                    <div class="home-slider-content flex-min-height-inner dark-bg-2">
                        ...
                        <div class="container top-bottom-padding-120 flex-container response-999">
                            ...
                            <div class="six-columns six-offset">
                                <div class="content-left-margin-40">
                                    <h2 class="slider-overlay2 medium-title red-color">Welcome To See The Light</h2>
                ...
                <div class="swiper-slide flex-min-height-box home-slide red-slide">
                    <!-- slide-bg -->
                    <div class="slide-bg" style="background-image:url({{asset('assets/images/backgrounds/slider_3.jpg')}})"></div>
                    <!-- home-slider-content start -->
...
{{--                                <span data-animation-child class="title-fill tr-delay01" data-animation="title-fill-anim" data-text="We are Xen">We are Xen</span>--}}
                        ...
                        <div class="six-columns">
                            <div class="content-right-margin-20">
                                <p data-animation-child class="p-style-medium text-color-5 fade-anim-box tr-delay02" data-animation="fade-anim" style="text-align: justify">
                        ...
                        <div class="six-columns">
                            <div class="content-left-margin-20">
                                <p data-animation-child class="p-style-medium text-color-5 fade-anim-box tr-delay03" data-animation="fade-anim" style="text-align: justify">
                                    See the Light is a hybrid digital media agency, which is driven by the belief of molding perceptions in the virtual world where your consumers exist. We are Pakistan’s fastest growing Digital Media Agency, which operates under the umbrella of Mobility Solutions, Digital Media and Technology Enablement.
                                </p>
                            </div>
                        </div><!-- column end -->
                        <!-- column start -->
                        <div class="twelve-columns text-center">
                            <p data-animation-child class="p-letter-style text-color-4 text-height-13 fade-anim-box tr-delay04" data-animation="fade-anim">
                                Our vision is to lead by innovation, technology and creativity gathering aspiration and achievements. Interactivity for everyone!Service description.
                            </p>
                        </div><!-- column end -->
                    </div><!-- flex-container end -->
                </div><!-- container end -->
                ...
                <ul class="client-list d-flex-wrap top-padding-60">
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/3eabc7ab-8bae-44f0-8389-0169389e38c2.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/1c4bfb0e-0b9f-4c19-ba5c-113fb0714514.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/6b9fcb90-c595-432a-a97c-fcd318b74c04.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/699301b6-83ff-47f8-ad46-a6b871e79293.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/7d1fe64f-fbd7-4e5f-896d-6d79c91f29bf.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/858e2e28-faae-441c-bd9c-5c490c72b562.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/8b587214-bdcb-4d74-bb61-2480d1d15aa7.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/4b983c9a-759d-4921-ba60-dbbcaa702ee5.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/8f65e211-cd41-46dc-8c1d-ba228ac36eb9.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/9c30d6d6-6af9-4fb1-bed3-e5ea4df4c281.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/4731da4b-b2fb-4c10-aee7-c89484a5d473.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/69cb9e61-d0b8-4420-b8bd-454c9b9e1dc1.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/492492b2-b7d9-4648-a164-f530ecd6321a.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/9a6c570f-d03a-4806-9a30-dddc648707d9.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/b908b85c-f837-4dba-80cf-d961d6fcad29.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/6e63c653-6997-42c6-b788-28e9fb6d15b7.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/d5f831cf-3fb0-490b-aadc-3591c8b64156.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/2ed0436b-e3ea-48aa-85ca-755de0719c9a.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="pointer-large d-block">
                            <div class="brand-box">
                                <img src="{{asset('assets/images/clients/d51e13e6-1320-4227-8bc8-c36aaa82dffd.png')}}" alt="Brand" class="hover-opac-img">
                                <img src="{{asset('assets/images/clients/aed14647-8ecf-4fef-8274-737d79a7ede1.png')}}" alt="Brand" class="opac-img">
                            </div>
                        </a>
                    </li>
                    <li>
        ...
        <div class="light-bg-2 top-bottom-padding-120" data-midnight="black">
            ...
            <div class="testimonials-slider container small">
                ...
                <div class="swiper-wrapper">
                    ...
                    <!-- slide start -->
                    <div class="swiper-slide text-center">
                        <img src="{{asset('assets/images/testimonials/pexels-photo-428340.jpg')}}" alt="author">
                        <div class="testimonials-content">
                    ...
                    <!-- slide start -->
                    <div class="swiper-slide text-center">
                        <img src="{{asset('assets/images/testimonials/pexels-photo-764529.jpg')}}" alt="author">
                        <div class="testimonials-content">
                    ...
                    <!-- slide start -->
                    <div class="swiper-slide text-center">
                        <img src="{{asset('assets/images/testimonials/pexels-photo-809433.jpg')}}" alt="author">
                        <div class="testimonials-content">
                    ...
                    <!-- slide start -->
                    <div class="swiper-slide text-center">
                        <img src="{{asset('assets/images/testimonials/pexels-photo-894156.jpg')}}" alt="author">
                        <div class="testimonials-content">
