...
@section('content')
    ...
    <main class="animsition-overlay" data-animsition-overlay="true">
        ...
        <section id="up" class="page-head flex-min-height-box dark-bg-2">
            <!-- page-head-bg -->
            <div class="page-head-bg overlay-loading2" style="background-image: url({{asset('assets/images/services/services_2.jpg')}});"></div>
        ...
        <section id="down" class="dark-bg-1 top-bottom-padding-120">
            ...
            <div class="top-padding-90">
                <!-- container start -->
                <div class="container">
                    <div class="services-bg" style="background-image:url({{asset('assets/images/services/achievement-brainstorming-branding-1162968.jpg')}})"></div>
                </div><!-- container end -->
            ...
            <div class="top-padding-90">
                <!-- container start -->
                <div class="container">
                    <div class="services-bg" style="background-image:url({{asset('assets/images/services/apple-books-computers-115655.jpg')}})"></div>
                </div><!-- container end -->
            ...
            <div class="top-padding-90">
                <!-- container start -->
                <div class="container">
                    <div class="services-bg" style="background-image:url({{asset('assets/images/services/american-casual-cellphone-1262971.jpg')}})"></div>
                </div><!-- container end -->
            ...
            <div class="flex-min-height-inner">
                ...
                <div class="flex-container container top-bottom-padding-120">
                    ...
                    <div class="six-columns bottom-padding-60">
                        <div class="progress-bg overlay-anim-box2" data-animation="overlay-anim2" style="background-image:url({{asset('assets/images/services/action-asia-blur-1455989.jpg')}})"></div>
                    </div><!-- column end -->
                    <!-- column start -->
                ...
                <div class="flex-container response-999 top-padding-60">
                    ...
                    <div class="four-columns bottom-padding-60">
                        <a data-animation-container href="#" class="content-right-margin-20 hover-box pointer-large d-block light-bg-2">
                            <div data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
                                <img class="hover-img" src="{{asset('assets/images/services/analysis-business-coffee-1549702.jpg')}}" alt="Digital products">
                            </div>
                    ...
                    <div class="four-columns bottom-padding-60">
                        <a data-animation-container href="#" class="content-left-right-margin-10 hover-box pointer-large d-block light-bg-2">
                            <div data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
                                <img class="hover-img" src="{{asset('assets/images/services/analysis-business-businesswoman-955447.jpg')}}" alt="Digital products">
                            </div>
                            <div class="expertise content-padding-l-r-20 content-padding-bottom-20">
                    ...
                    <div class="four-columns bottom-padding-60">
                        <a data-animation-container href="#" class="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
                            <div data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
                                <img class="hover-img" src="{{asset('assets/images/services/beautiful-brainstorming-business-1136757.jpg')}}" alt="Digital products">
                            </div>
                            <div class="expertise content-padding-l-r-20 content-padding-bottom-20">
                    ...
                    <div class="four-columns bottom-padding-60">
                        <a data-animation-container href="#" class="content-right-margin-20 hover-box pointer-large d-block light-bg-2">
                            <div data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
                                <img class="hover-img" src="{{asset('assets/images/services/action-plan-brainstorming-complex-212286.jpg')}}" alt="Digital products">
                            </div>
                            <div class="expertise content-padding-l-r-20 content-padding-bottom-20">
                    ...
                    <div class="four-columns bottom-padding-60">
                        <a data-animation-container href="#" class="content-left-right-margin-10 hover-box pointer-large d-block light-bg-2">
                            <div data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
                                <img class="hover-img" src="{{asset('assets/images/services/business-business-people-calendar-1187439.jpg')}}" alt="Digital products">
                            </div>
                            <div class="expertise content-padding-l-r-20 content-padding-bottom-20">
                    ...
                    <div class="four-columns bottom-padding-60">
                        <a data-animation-container href="#" class="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
                            <div data-animation-child class="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
                                <img class="hover-img" src="{{asset('assets/images/services/analysis-analytics-application-590016.jpg')}}" alt="Digital products">
                            </div>
                            <div class="expertise content-padding-l-r-20 content-padding-bottom-20">
